...
def exit_handler():
    ...
    # np.savetxt("first_1000_x_pos_pixels.csv", x_pos_arr, delimiter=",")
    # np.savetxt("first_1000_times.csv", time_arr, delimiter=",")
...
def initialize():
    global cap, origin_px, meter_per_px
    #cap = cv2.VideoCapture(2)
    cap = cv2.VideoCapture("videos\PendulumTrial01.m4v")
...
def main():
    ...
    i = 0
    while(i < 27000): #full video
    # while(i < 1050): #first 1000 frames
        i += 1
        print(i)
        ret,frame = cap.read()
